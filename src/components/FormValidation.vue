...
const isPassvalid = computed(() => formData.value.password.length >= 8)

const isFormValid = computed(() => isNameValid.value && isEmailValid.value && isPassvalid.value)
  ...
  <div>
    <form @submit.prevent="submitForm" class="custom-form">
      ...
      <div class="form-group">
        ...
        <span v-if="!isPassvalid" class="error">Password must be at least 8 characteres</span>
      </div>
